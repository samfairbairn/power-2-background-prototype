  ...
  return (
    <div className={styles.screen} style={{top: `550vh`, height: '150vh', flexDirection: "column"}}>
      ...
      <div ref={titleRef} className={styles.center} style={{height: '75vh'}}>
        ...
        <h2>
          They'll grow to the moon, thanks to<br />
          POWER2 Virtuous Snowball Cycles.
        </h2>

        <p>
          The Virtuous Snowball Cycles forms a positive back loop of higher demands,<br/>
          which causes higher POWER2 token and iNFT prices.<br />
