...
const Screen4 = () => {
  ...
  return (
    <div className={classNames([styles.screen, styles.alignRight])} style={{top: `300vh`, alignItems: 'flex-start', paddingTop: '20vh'}}>

      <span className={classNames([styles.big1, styles.gradient1])} style={{top: '20vh'}}>1</span>
